...
class CommandLineTool {
  ...
  setOptions (options) {
    if (this.optionParser == null) {
      ...
      this.optionParser.boolKey('vvdebug') // Show very verbose debug messages.
