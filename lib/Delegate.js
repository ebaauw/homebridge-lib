...
class Delegate extends events.EventEmitter {
  ...
  debug (format, ...args) {
    this._platform._message(
      'debug', this._logLevel, this._namePrefix, format, ...args
    )
  }
  ...
  error (format, ...args) {
    this._platform._message(
      'error', this._logLevel, this._namePrefix, format, ...args
    )
  }
  ...
  fatal (format, ...args) {
    this._platform._message(
      'fatal', this._logLevel, this._namePrefix, format, ...args
    )
  ...
  log (format, ...args) {
    this._platform._message(
      'log', this._logLevel, this._namePrefix, format, ...args
    )
  }
  ...
  warn (format, ...args) {
    this._platform._message(
      'warning', this._logLevel, this._namePrefix, format, ...args
    )
  }
}
