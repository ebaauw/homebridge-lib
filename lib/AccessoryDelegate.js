...
class AccessoryDelegate extends homebridgeLib.Delegate {
  ...
  constructor (platform, params = {}) {
    ...
    this.addPropertyDelegate({ key: 'version', value: this.name, silent: true })
    this.addPropertyDelegate({ key: 'id', value: this.id, silent: true })
    ...
    this.addPropertyDelegate({ key: 'uiPort' })
