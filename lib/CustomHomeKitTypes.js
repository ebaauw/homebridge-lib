...
class CustomHomeKitTypes {
  ...
  /** Valid HomeKit characteristic admin-only permissions.
    * <br>See {@link Characteristic.RestrictedPerms}.
    * @type {Object<string, Characteristic.RestrictedPerms>}
    * @readonly
    */
  get RestrictedPerms () {
  ...
  /** Valid HomeKit characteristic formats.
    ...
    * @readonly
    */
  get Formats () { return hap.Characteristic.Formats }
  ...
  /** Valid HomeKit characteristic permissions.
    ...
    * @readonly
    */
  get Perms () { return hap.Characteristic.Perms }
  ...
  /** Standard HomeKit characteristic units.
    ...
    * @readonly
    */
  get Units () { return hap.Characteristic.Units }
  ...
  /** @link Characteristic} subclasses for standard HomeKit characteristics.
    ...
    * @readonly
    */
  get hapCharacteristics () { return hap.Characteristic }
  ...
  /** {@link Service} subclasses for custom HomeKit services.
    ...
    * @readonly
    */
  get hapServices () { return hap.Service }
  ...
  createCharacteristicClass (key, uuid, props, displayName = key) {
    ...
    this._Characteristics[key] = function () {
      hap.Characteristic.call(this, displayName, uuid)
      if (props.restrictedPerms != null) {
        this.accessRestrictedToAdmins = props.restrictedPerms
        delete props.restrictedPerms
      }
      this.setProps(props)
      this.value = this.getDefaultValue()
    }
    util.inherits(this._Characteristics[key], hap.Characteristic)
  ...
  createServiceClass (key, uuid, Characteristics, OptionalCharacteristics = []) {
    ...
    this._Services[key] = function (displayName, subtype) {
    ...
    util.inherits(this._Services[key], hap.Service)
