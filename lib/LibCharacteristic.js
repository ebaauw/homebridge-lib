 ...
 * @extends LibObject
 */
class LibCharacteristic extends homebridgeLib.LibObject {
  /**
   * Create a new instance of a HomeKit chracteristic delegate.
   *
   * @param {!LibService} serviceDelegate - Reference to the corresponding
  ...
  constructor (serviceDelegate, params = {}) {
    if (!(serviceDelegate instanceof require('./LibService'))) {
      throw new TypeError('serviceDelegate: not a LibService')
    }
  ...
  set value (value) {
     ...
     * device attribute.
     * @event LibCharacteristic#didSet
...
module.exports = LibCharacteristic
