...
module.exports = class MyHomeKitTypes extends CustomHomeKitTypes {
  constructor (homebridge) {
    ...
    this.createCharacteristic('ChangeVolume', my.uuid('049'), {
      format: this.formats.INT,
      minValue: -1,
      maxValue: 1,
      minStep: 1, // Force Down|Up control in Eve
    ...
    // Used by homebridge-zp in Sonos service.
    this.createCharacteristic('ChangeInput', my.uuid('04A'), {
      format: this.formats.INT,
      minValue: -1,
      maxValue: 1,
      minStep: 1, // Force Down|Up control in Eve
    ...
    this.createService('Sonos', hap.Service.Switch.UUID, [
      ...
      my.Characteristic.ChangeVolume,
