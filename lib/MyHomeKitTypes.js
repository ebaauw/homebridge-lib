...
class MyHomeKitTypes extends homebridgeLib.CustomHomeKitTypes {
  ...
  constructor (homebridge) {
    ...
    /** @member MyHomeKitTypes#Characteristics
      ...
      * @property {Class} BrightnessChange - For relative changes to `Brightness`.
      ...
      * @property {Class} Colorloop - Colorloop.
      ...
      * @property {Class} Duration - Deprecated - use `eve.Duration`.
      ...
      * @property {Class} Locked - Deprecated - use `hap.LockPhysicalControls`.
      ...
      * @property {Class} Restart - Restart device; indication that device has restarted.
      * @property {Class} ReturnWaterTemperature - Temperature of the water returning to the boiler.
      * @property {Class} Sensitivity - Deprecated- use `hap.Sensitivity`.
      * @property {Class} SonosCoordinator - Zone player is target coordinator for grouping.
      * @property {Class} SonosGroup - Current Sonos group to which zone player belongs.
      ...
      * @property {Class} TotalConsumptionLow - Total consumption under low tariff.
      * @property {Class} TotalConsumptionNormal - Total consumption under high tariff.
      ...
      * @property {Class} UniqueID - Used by Hue app to sync room assignments for lights.
      * @property {Class} WaterPressure - Water pressure (in bar) of the central heating system.
      */
    ...
    // Used by homebridge-hue in Status service, homebridge-ws.
    ...
    // Used by homebridge-hue in MotionSensor service.
    // Deprecated in favour of Eve's Duration.
    ...
    // Deprecated in favour of HAP's LockPhysicalControls.
    ...
    // Used by homebridge-hue, homebridge-ws.
    ...
    // Used by homebridge-hue, homebridge-rpi.
    this.createCharacteristicClass('Restart', uuid('058'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.READ, this.Perms.NOTIFY, this.Perms.WRITE],
      adminOnlyAccess: [this.Access.READ, this.Access.WRITE]
    })
    ...
    // Used by homebridge-ws.
    this.createCharacteristicClass('WindChill', uuid('062'), {
      format: this.Formats.FLOAT,
      unit: this.Units.CELSIUS,
      maxValue: 100,
      minValue: -40,
