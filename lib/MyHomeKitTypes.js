...
class MyHomeKitTypes extends CustomHomeKitTypes {
  ...
  constructor (homebridge) {
    ...
    /** @member MyHomeKitTypes#Characteristics
      ...
      * @property {Class} CarnivalEffect - Enabled/disable carnival dynamic effect.
      * <br>Used by: homebridge-deconz.
      ...
      * @property {Class} CollideEffect - Enabled/disable collide dynamic effect.
      * <br>Used by: homebridge-deconz.
      ...
      * <br>Used by: homebridge-deconz, homebridge-hue2.
      * @property {Class} FadingEffect - Enabled/disable fading dynamic effect.
      * <br>Used by: homebridge-deconz.
      * @property {Class} FireEffect - Enabled/disable fire dynamic effect.
      * <br>Used by: homebridge-deconz, homebridge-hue2.
      * @property {Class} FireworksEffect - Enabled/disable fireworks dynamic effect.
      * <br>Used by: homebridge-deconz.
      * @property {Class} FireplaceEffect - Enabled/disable fire dynamic effect.
      * <br>Deprecated - use `FireEffect`.
      * <br>Used by: homebridge-deconz, homebridge-hue2.
      * @property {Class} FlagEffect - Enabled/disable flag dynamic effect.
      * <br>Used by: homebridge-deconz.
      * @property {Class} GlistenEffect - Enabled/disable glisten dynamic effect.
      * <br>Used by: homebridge-deconz, homebridge-hue2.
      * @property {Class} GlowEffect - Enabled/disable glow dynamic effect.
      * <br>Used by: homebridge-deconz.
      ...
      * <br>Used by: homebridge-otgw.
      * @property {Class} RainbowEffect - Enabled/disable rainbow dynamic effect.
      * <br>Used by: homebridge-deconz.
      ...
      * <br>Used by: homebridge-zp.
      * @property {Class} SnakeEffect - Enabled/disable snake dynamic effect.
      * <br>Used by: homebridge-deconz.
      * @property {Class} SnowEffect - Enabled/disable snow dynamic effect.
      * <br>Used by: homebridge-deconz.
      ...
      * <br>Used by: homebridge-zp in Speaker service.
      * @property {Class} TwinkleEffect - Enabled/disable twinkle dynamic effect.
      * <br>Used by: homebridge-deconz.
      ...
      * <br>Used by: homebridge-deconz.
      * @property {Class} UpdownEffect - Enabled/disable updown dynamic effect.
      * <br>Used by: homebridge-deconz.
      * @property {Class} VintageEffect - Enabled/disable vintage dynamic effect.
      * <br>Used by: homebridge-deconz.
      * @property {Class} WaterPressure - Water pressure (in bar) of the central
      * heating system.
      * <br>Used by: homebridge-otgw.
      * @property {Class} WavesEffect - Enabled/disable waves dynamic effect.
      * <br>Used by: homebridge-deconz.
    ...
    // Effects for LIDL Xmas lightstrip.

    this.createCharacteristicClass('SteadyEffect', uuid('099'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Steady')

    this.createCharacteristicClass('SnowEffect', uuid('09A'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Snow')

    this.createCharacteristicClass('RainbowEffect', uuid('09B'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Rainbow')

    this.createCharacteristicClass('SnakeEffect', uuid('09C'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Snake')

    this.createCharacteristicClass('TwinkleEffect', uuid('09D'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Twinkle')

    this.createCharacteristicClass('FireworksEffect', uuid('09E'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Fireworks')

    this.createCharacteristicClass('FlagEffect', uuid('09F'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Flag')

    this.createCharacteristicClass('WavesEffect', uuid('0A0'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Waves')

    this.createCharacteristicClass('UpdownEffect', uuid('0A1'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Updown')

    this.createCharacteristicClass('Vintageffect', uuid('0A2'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Vintage')

    this.createCharacteristicClass('FadingEffect', uuid('0A3'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Fading')

    this.createCharacteristicClass('CollideEffect', uuid('0A4'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Collide')

    this.createCharacteristicClass('StrobeEffect', uuid('0A5'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Strobe')

    this.createCharacteristicClass('SparklesEffect', uuid('0A6'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Sparkles')

    this.createCharacteristicClass('CarnivalEffect', uuid('0A7'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Carnival')

    this.createCharacteristicClass('GlowEffect', uuid('0A8'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.PAIRED_READ, this.Perms.NOTIFY, this.Perms.PAIRED_WRITE]
    }, 'Glow')
