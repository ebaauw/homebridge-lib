...
class MyHomeKitTypes extends homebridgeLib.CustomHomeKitTypes {
  ...
  constructor (homebridge) {
    ...
    /** @member MyHomeKitTypes#Characteristics
      ...
      * by Homebridge RPi, by Homebridge WS.
    ...
    // Used for Adaptive Lighting.
    this.createCharacteristicClass(
      'TransitionControl', MyHomeKitTypes.uuid('143'), {
        format: this.Formats.TLV8,
        perms: [this.Perms.READ, this.Perms.WRITE, this.Perms.WRITE_RESPONSE]
      }, 'Transition Control'
    )

    // Used for Adaptive Lighting.
    this.createCharacteristicClass(
      'SupportedTransitionConfiguration', MyHomeKitTypes.uuid('144'), {
        format: this.Formats.TLV8,
        perms: [this.Perms.READ]
    ...
    // Used for Adaptive Lighting.
    this.createCharacteristicClass(
      'ActiveTransitionCount', MyHomeKitTypes.uuid('24B'), {
        format: this.Formats.UINT8,
        perms: [this.Perms.READ, this.Perms.NOTIFY]
