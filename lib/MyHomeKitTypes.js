...
class MyHomeKitTypes extends homebridgeLib.CustomHomeKitTypes {
  ...
  constructor (homebridge) {
    ...
    /** @member MyHomeKitTypes#Characteristics
      ...
      * @property {Class} BurnerStarts - # burner starts.
      ...
      * @property {Class} LastBoot - Time of last device boot.
      ...
      * @property {Class} Locked - Deprecated, use Characteristics.hap.LockPhysicalControls.
      ...
      * @property {Class} PumpStarts - # pump starts
      ...
      * @property {Class} Sensitivity - Deprecated, use Characteristics.hap.Sensitivity.
    ...
    this.createCharacteristicClass('Heartrate', uuid('024'), {
      ...
      minStep: 1,
      perms: [this.Perms.READ, this.Perms.NOTIFY, this.Perms.WRITE],
      restrictedPerms: [this.RestrictedPerms.WRITE]
    })
    ...
    this.createCharacteristicClass('Restart', uuid('058'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.READ, this.Perms.NOTIFY, this.Perms.WRITE],
      restrictedPerms: [this.RestrictedPerms.READ, this.RestrictedPerms.WRITE]
    })
