...
class MyHomeKitTypes extends homebridgeLib.CustomHomeKitTypes {
  ...
  constructor (homebridge) {
    ...
    // Used by homebridge-hue.
    this.createCharacteristicClass('BrightnessUp', uuid('057'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.READ, this.Perms.NOTIFY, this.Perms.WRITE]
    }, 'Brightness Up')

    // Used by homebridge-hue.
    this.createCharacteristicClass('BrightnessDown', uuid('058'), {
      format: this.Formats.BOOL,
      perms: [this.Perms.READ, this.Perms.NOTIFY, this.Perms.WRITE]
    }, 'Brightness Down')

    // Used by homebridge-hue.
    this.createCharacteristicClass('BrightnessStep', uuid('059'), {
      format: this.Formats.INT,
      minValue: 0,
      maxValue: 100,
      minStep: 1,
