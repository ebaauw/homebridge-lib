 ...
 * @extends LibObject
 */
class LibService extends homebridgeLib.LibObject {
  /**
   ...
   * @param {!LibAccessory} accessoryDelegate - Reference to the corresponding
   ...
   * each key specified in {@link LibService#characteristics characteristics}.
   ...
   * Used in the `params` parameter to the {@link LibService constructor} and
   * in {@link LibService#values values}.<br>
   * Must be unqiue within the service.  Note that `LibService` already defines
   * `name` for the _Name_ characteristic.
   * @property {!Characteristic} Specification[].Characteristic - The type of the
   * characteristic, from {@link LibObject#Characteristic Characteristic}.
   ...
   * to the {@link LibService constructor}.
   ...
   *
   * Contains the key of each specification in {@link LibService#characteristics
   ...
   * LibService#characteristics characteristics}.
   * @param {!string} key - The key for the characteristic.
   * returns {LibCharacteristic}
   */
 ...
 * @memberof LibService
 */
class AccessoryInformation extends LibService {
  /**
   * Create a new instance of an _AccessoryInformation_ service delegate.
   * @param {!LibAccessory} accessoryDelegate - The delegate of the
 ...
 * @memberof LibService
 */
class History extends LibService {
  /**
  ...
  constructor (accessoryDelegate, params = {}) {
    ...
    this.platform.on('heartbeat', this._heartbeat.bind(this))
    this.platform.on('shutdown', this._save.bind(this))
    this._load()
  }
 ...
 * @extends LibService.History
 * @memberof LibService.History
 */
class Consumption extends LibService.History {
  /**
   ...
   * derive the name of the file to persist the history, typically
   * `~/.homebridge/accessories/history_`id`.json`
   * @param {!LibCharacteristic} consumptionDelegate - A reference to the
   * delegate of the associated `Characteristic.eve.TotalConsumption`
   * characteristic.
   * @param {LibCharacteristic} powerDelegate - A reference to the
 ...
 * @memberof LibService.History
 */
class Contact extends LibService.History {
  /**
   ...
   * derive the name of the file to persist the history, typically
   * `~/.homebridge/accessories/history_`id`.json`
   * @param {!LibCharacteristic} contactDelegate - A reference to the
   * delegate of the associated `Characteristic.hap.ContactSensorState`
   * characteristic.
   * @param {!LibCharacteristic} timesOpenedDelegate - A reference to the
   * delegate of the associated `Characteristic.eve.TimesOpened`
   * characteristic.
   * @param {!LibCharacteristic} lastActivationDelegate - A reference to the
 ...
 * @memberof LibService.History
 */
class Motion extends LibService.History {
  /**
   ...
   * derive the name of the file to persist the history, typically
   * `~/.homebridge/accessories/history_`id`.json`
   * @param {!LibCharacteristic} motionDelegate - A reference to the
 ...
 * @memberof LibService.History
 */
class Power extends LibService.History {
  /**
   * Create a new instance of an Eve Energy _History_ service delegate.
   * @param {!LibAccessory} accessoryDelegate - The delegate of the
   * corresponding HomeKit accessory.
 ...
 * @memberof LibService.History
 */
class Weather extends LibService.History {
  /**
   ...
   * derive the name of the file to persist the history, typically
   * `~/.homebridge/accessories/history_`id`.json`
   * @param {!LibCharacteristic} temperatureDelegate - A reference to the
   * delegate of the associated `Characteristic.eve.CurrentTemperature`
   * characteristic.
   * @param {!LibCharacteristic} humidityDelegate - A reference to the
   * delegate of the associated `Characteristic.hap.CurrentRelativeHumidity`
   * characteristic.
   * @param {!LibCharacteristic} pressureDelegate - A reference to the
