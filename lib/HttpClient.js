...
class HttpClient extends events.EventEmitter {
  /** HTTP request.
    * @typedef
    * @property {integer} id - The ID of the request.
    * @property {string} method - Method of the request.
    * @property {string} resource - Resource of the request.
  ...
  /** HTTP response.
    * @typedef
    * @property {HttpRequest} request - The request.
            ...
            .on('end', () => {
              ...
              if (buffer != null) {
                if (
                  ...
                  responseInfo.body = this.__params.text ? buffer.toString('utf-8') : buffer
                }
              }
